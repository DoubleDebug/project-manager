...
var ManagerModel = /** @class */ (function () {
    function ManagerModel() {
        ...
        if (currentUserId === '')
            ...
            _databaseAPI__WEBPACK_IMPORTED_MODULE_0__.DatabaseAPI.getUserById(Number(currentUserId)).then(function (user) {
    ...
    ManagerModel.prototype.trySignUpUser = function (nickname, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _databaseAPI__WEBPACK_IMPORTED_MODULE_0__.DatabaseAPI.addUser(nickname, password)];
                    case 1:
                        response = _a.sent();
...
var ManagerView = /** @class */ (function () {
    ...
    ManagerView.prototype.trySignUp = function (model, loginForm) {
        return __awaiter(this, void 0, void 0, function () {
            var nn, pswd, errorMsg, signupMsg, lblError, loginBtn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        nn = document.getElementById('inputLoginNickname').value;
...
/* harmony import */ var _databaseAPI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./databaseAPI */ "./src/ts/databaseAPI.ts");
/* harmony import */ var _manager_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manager/controller */ "./src/ts/manager/controller.ts");



var dbURL = 'http://localhost:3000';
_databaseAPI__WEBPACK_IMPORTED_MODULE_1__.DatabaseAPI.setRootURL(dbURL);
var manager = new _manager_controller__WEBPACK_IMPORTED_MODULE_2__.Manager();
